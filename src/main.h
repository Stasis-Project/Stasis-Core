...
#define START_MASTERNODE_PAYMENTS_TESTNET 1508981174
#define START_MASTERNODE_PAYMENTS 1508981174

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (599999.99*COIN);

//static const int64_t STATIC_POS_REWARD = 55 * COIN; //Constant reward of 1 SAS per COIN i.e. 8%
...
static const int64_t MIN_TX_FEE = 1337;
