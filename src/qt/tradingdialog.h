...
private slots:
    ...
    QString BuySAS(QString OrderType, double Quantity, double Rate);
    QString SellSAS(QString OrderType, double Quantity, double Rate);
